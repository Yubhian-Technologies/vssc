...
const ButtonGradient = ({ name, onClick }) => {
  return (
    <button
      onClick={onClick}
      className="btn relative flex cursor-pointer items-center justify-center overflow-hidden rounded-[100px] border-none p-[2.5px]"
    >
