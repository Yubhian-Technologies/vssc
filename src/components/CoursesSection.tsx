...
const CoursesSection = () => {
  ...
  const courses = {
    ...
    "INSIDE OUT": [
      {
        focus:
          "Prompt-based Reflective Sessions for self-awareness & life-skills",
    ...
    "HAPPY FEET": [
      ...
      {
        focus:
          "Student-led health and hygiene circle to promote peer-awareness",
        desc: "Wellness & Self-Care",
        image: maroon1,
      },
    ],
