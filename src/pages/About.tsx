    ...
    <div className="w-full">
      ...
      <section className="w-full py-28 px-6 md:px-12 lg:px-20 bg-[hsl(60,100%,95%)]">
        <div className="max-w-6xl mx-auto flex flex-col md:grid md:grid-cols-2 gap-12 items-center">
          <h2 className="text-3xl font-bold text-primary text-center md:hidden mb-6">
            About Us
          </h2>
          ...
          <div className="flex flex-col space-y-6">
            <h2 className="hidden md:block text-3xl font-bold text-primary">
              About Us
            </h2>
            <p className="text-gray-700 leading-relaxed">
              The Vishnu Student Success Centre is open to all students within
              the Sri Vishnu Educational Society. Whether you are a first-year
              student adjusting to college life, a senior preparing for
              professional life, or anywhere in between, our resources and
              services are designed to meet your unique needs and help you
              succeed.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="md:w-1/2 w-full flex flex-col items-start space-y-4">
            ...
            <p className="text-gray-700 leading-relaxed  text-md">
              We are committed to helping students navigate their educational
              paths, overcome challenges, and achieve their goals through
          ...
          <div className="md:w-2/3 w-full flex justify-center md:justify-end">
            <div
              className="w-[90%] md:w-[70%] bg-[#001E6C] flex flex-col justify-center items-center text-center py-16 px-6 md:px-8 space-y-10 border-3 border-white rounded-[50px] shadow-[0_25px_50px_rgba(0,0,0,0.4)] 
                  transition-transform duration-300 ease-in-out hover:-translate-y-3 hover:shadow-[0_35px_60px_rgba(0,0,0,0.5)]"
            >
              {/* Heading */}
              <div>
                <h2
              ...
              <div className="bg-background text-black p-8 md:p-10 rounded-3xl shadow-[0_10px_25px_rgba(0,0,0,0.2)] max-w-[90%] mx-auto transition-shadow duration-300 ease-in-out hover:shadow-[0_20px_35px_rgba(0,0,0,0.3)]">
                <p className="text-md md:text-md leading-relaxed font-serif">
                  To create a supportive, inclusive, and dynamic environment
                  where every student can discover their potential, build
                  essential life skills, and confidently shape their future.
                </p>
              </div>
            </div>
          </div>
