      ...
      <section className="w-full bg-gray-50 py-8 px-6 md:px-12 lg:px-20 [background-color:hsl(60,100%,90%)]">
        <div className="container mx-auto text-center">
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl mx-auto">
             Our care and concern for our students is not limited to their college experience. It 
             comes with a warm farsight for our budding future professionals! Be it corporate 
             readiness or professional etiquettes, our goal is to ensure our students have the 
             essential skills and confidence for professional excellence. Let us help you make a 
             lasting impression
          </p>
        </div>
      </section>
