      ...
      <div className="p-6 min-h-screen [background-color:hsl(60,100%,95%)]">
        ...
        {userData?.role === "admin" && (
          <button
            ...
            className="fixed bottom-24 right-6 z-50 bg-blue-800 text-white  w-12 h-12 flex items-center justify-center text-3xl shadow-lg hover:bg-blue-700 rounded-full p-6"
          >
            +
          </button>
        )}
            ...
            <div className="bg-[hsl(60,100%,97%)] rounded-2xl shadow-2xl w-full max-w-lg p-6 md:p-8 overflow-y-auto max-h-[90vh]">
              ...
              <div className="mb-4 p-4 bg-yellow-100 rounded-xl border border-yellow-300">
                ...
                <p className="text-gray-700">
                  Date:{" "}
                  <span className="font-normal">{selectedSession.date}</span>{" "}
                  <span className="font-normal">
