...
const sessions = [
  {
    ...
    cover: event4,
    description:
      "Explore your inner self and discover your true passions, values, and strengths through guided self-reflection.",
  },
];

const courses = [
  {
    focus: "Prompt-based Reflective Sessions for self-awareness & life-skills",
    desc: "Knowing Yourself",
    image: red1,
  },
  {
    focus:
      "Self-growth through personal vision-boards & goal-setting workshops",
    desc: "Knowing Yourself",
    image: red2,
  },
  {
    focus: "Access to one-on-one counselling",
    desc: "Knowing Yourself",
    image: red3,
  },
  {
    focus: "Personality assessments and peer feedback sessions",
    desc: "Knowing Yourself",
    image: red4,
  },
  {
    focus: "Student-run empathy circle (sharing and problem-solving)",
    desc: "Knowing Yourself",
    image: red1,
  },
  {
    focus: "Emotional intelligence: Development and Regulation",
    desc: "Knowing Yourself",
    image: red2,
  },
];
            ...
            {sessions.map((session) => (
              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-center items-center md:items-start text-center md:text-left gap-4 p-2 max-h-[300px] mt-20">
                  ...
                  <h2
                    className="text-4xl font-extrabold leading-tight text-purple-500"
                    style={{
                      fontFamily:
                        "'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif",
                      margin: 0,
