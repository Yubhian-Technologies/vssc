...
const sessions = [
  {
    id: 1,
    name: "Discover Networand Opportunities",
    cover: event1,
    description: "Learn effective networking strategies to build meaningful professional connections and discover new opportunities in your field.",
  },
];
