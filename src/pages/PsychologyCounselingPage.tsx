...
export default function PsychologyCounselingPage() {
  ...
  const handleAddSession = async () => {
    if (
      ...
      alert("Please fill in all required fields (title, description, counselor name, skills, date, and session type). For 1-on-1, include start time, total duration, and slot duration. For group, include start time.");
      return;
    }
  ...
  return (
    <div>
      ...
      <div className="relative w-full h-72 md:h-96 lg:h-[28rem]">
        ...
        >
          Available PsychologyCounseling Sessions
        </motion.h1>
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4 overflow-y-auto">
          <div className="bg-white rounded-xl p-6 w-full max-w-lg space-y-4 max-h-[90vh] overflow-y-auto">
            <h2 className="text-xl font-bold">Add New Psychology Counseling Session</h2>
