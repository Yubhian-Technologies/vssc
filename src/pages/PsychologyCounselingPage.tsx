...
export default function PsychologyCounselingPage() {
  ...
  const handleAddSession = async () => {
    ...
    try {
      const sessionData: any = {
        ...
        slotAvailable: Math.floor(newSession.totalDuration / newSession.slotDuration),
        participants: [],
              ...
              <form className="space-y-6">
                ...
                <div className="space-y-4 p-2 bg-green-50 rounded-xl border border-green-100">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-2">
                      <label htmlFor="date" className="font-semibold text-gray-700 text-sm">
                        Start Date
                      </label>
                      <input
                        type="date"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="startTime" className="font-semibold text-gray-700 text-sm">
                        Start Time
                      </label>
                      <input
                        type="time"
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4 sm:p-0">
    <div className="bg-[hsl(60,100%,95%)] rounded-xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto shadow-lg">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="[background-color:hsl(60,100%,95%)] rounded-xl p-6 w-96">
              ...
              <p className="mb-4 text-gray-700">
                Are you sure you want to cancel <strong>{sessionToCancel.title}</strong>? This will
                delete the psychology counseling session and all related bookings.
              </p>
              <div className="flex justify-end gap-4">
                <button
